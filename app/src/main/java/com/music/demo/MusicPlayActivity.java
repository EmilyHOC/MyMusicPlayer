...
import com.music.adapter.GridViewAdapter;
import com.music.adapter.ListViewAdapter;
import com.music.interfaces.IOnServiceConnectComplete;
import com.music.interfaces.IOnSliderHandleViewClickListener;
...
import com.music.widget.GalleryFlow;
import com.music.widget.ImageAdapter;
import com.music.widget.MySlidingDrawer;
...
public class MusicPlayActivity extends Activity implements IOnServiceConnectComplete {
    ...
    public void onMenuItemClick(int pos) {
        switch (pos) {
            case 0:
                Toast.makeText(this, "未开放设置功能", Toast.LENGTH_SHORT).show();
                break;
            case 1:
                showDialog(ABOUT_DIALOG_ID);
                break;
            case 2:
                Toast.makeText(this, "未开放云同步功能", Toast.LENGTH_SHORT).show();
                break;
            case 3:
                exit();
                break;
    ...
    class MusicPlayStateBrocast extends BroadcastReceiver {
        ...
        public void TransPlayStateEvent(Intent intent) {
            ...
            switch (playState) {
                case MusicPlayState.MPS_INVALID:
                    mMusicTimer.stopTimer();
                    Toast.makeText(MusicPlayActivity.this, "无效的音频文件", Toast.LENGTH_SHORT).show();
    ...
    public boolean onMenuOpened(int featureId, Menu menu) {        // �ػ�˵��¼�
        // TODO Auto-generated method stub
