 ...
 * Original file: D:\\AnroidProject\\03MyMusic\\app\\src\\main\\aidl\\com\\music\\aidl\\MusicConnect.aidl
 */
package com.music.aidl;
public interface MusicConnect extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.music.aidl.MusicConnect
{
private static final java.lang.String DESCRIPTOR = "com.music.aidl.MusicConnect";
...
/**
 * Cast an IBinder object into an com.music.aidl.MusicConnect interface,
 * generating a proxy if needed.
 */
public static com.music.aidl.MusicConnect asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.music.aidl.MusicConnect))) {
return ((com.music.aidl.MusicConnect)iin);
}
return new com.music.aidl.MusicConnect.Stub.Proxy(obj);
}
...
java.util.List<com.music.musicplay.MusicData> _arg0;
_arg0 = data.createTypedArrayList(com.music.musicplay.MusicData.CREATOR);
...
data.enforceInterface(DESCRIPTOR);
java.util.List<com.music.musicplay.MusicData> _arg0;
_arg0 = new java.util.ArrayList<com.music.musicplay.MusicData>();
...
private static class Proxy implements com.music.aidl.MusicConnect
{
...
@Override public void refreshMusicList(java.util.List<com.music.musicplay.MusicData> musicFileList) throws android.os.RemoteException
{
...
@Override public void getFileList(java.util.List<com.music.musicplay.MusicData> musicFileList) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_reply.readException();
_reply.readTypedList(musicFileList, com.music.musicplay.MusicData.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
public void refreshMusicList(java.util.List<com.music.musicplay.MusicData> musicFileList) throws android.os.RemoteException;
public void getFileList(java.util.List<com.music.musicplay.MusicData> musicFileList) throws android.os.RemoteException;
